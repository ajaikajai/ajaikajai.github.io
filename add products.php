...
<form method="post" action="table.php" class="valida" enctype="multipart/form-data" autocomplete="off" novalidate="novalidate">
    <div class="input-info">
        <h3>Input Texts:</h3>
    </div>

    <label for="productName">Product Name: (required)&nbsp;<span class="at-required-highlight">*</span></label>
    ...
    <div class="form-group">
        <input type="number" name="price" class="form-control" required="true">
    </div>

    <label for="Quandity">Quantity: (required)&nbsp;<span class="at-required-highlight">*</span></label>
    <div class="form-group">
        <input type="number" name="Quandity" class="form-control" required="true">
    </div>

    <div>
        <input type="file" name="img" id="fileInput"><br>
    </div>
